...
import 'servicos_realizados_model.dart';
export 'servicos_realizados_model.dart';
...
class _ServicosRealizadosWidgetState extends State<ServicosRealizadosWidget> {
  late ServicosRealizadosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ServicosRealizadosModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Servicos_realizados'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SERVICOS_REALIZADOS_arrow_back_rounded_I');
            ...
            children: [
              Container(
                ...
                child: Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 22.0, 16.0, 1.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          () async {
                            logFirebaseEvent(
                                'SERVICOS_REALIZADOS_TextField_bubraj4o_O');
              ...
              Padding(
                ...
                child: Builder(
                  builder: (context) {
                    final pesquisa =
                        _model.simpleSearchResults.toList().take(1).toList();
                      ...
                      itemBuilder: (context, pesquisaIndex) {
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'SERVICOS_REALIZADOS_userList_5_ON_TAP');
