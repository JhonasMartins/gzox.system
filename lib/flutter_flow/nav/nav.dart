        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'manutencao',
              asyncParams: {
                'document': getDoc(['veiculo'], VeiculoRecord.fromSnapshot),
              },
            ...
            FFRoute(
              ...
              path: 'mapa',
              asyncParams: {
                'cities': getDoc(['mapas'], MapasRecord.fromSnapshot),
              },
            ...
            FFRoute(
              name: 'Cadastrar_o_produtoCopy',
              path: 'cadastrarOProdutoCopy',
              asyncParams: {
                'document': getDoc(['veiculo'], VeiculoRecord.fromSnapshot),
              },
              builder: (context, params) => CadastrarOProdutoCopyWidget(
                document: params.getParam('document', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'Detalhes_da_aplicacaoCopy',
              path: 'teste',
              builder: (context, params) => DetalhesDaAplicacaoCopyWidget(
                placa3: params.getParam('placa3', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'validacaodecodigo1',
              path: 'validacaodecodigo1',
              asyncParams: {
                'referencia': getDoc(['veiculo'], VeiculoRecord.fromSnapshot),
              },
              builder: (context, params) => Validacaodecodigo1Widget(
                placa: params.getParam('placa', ParamType.String),
            ...
            FFRoute(
              name: 'validacaod',
              path: 'validacaod',
              builder: (context, params) => ValidacaodWidget(
                placa: params.getParam('placa', ParamType.String),
                marca: params.getParam('marca', ParamType.String),
                modelo: params.getParam('modelo', ParamType.String),
                tipo: params.getParam('tipo', ParamType.String),
            ...
            FFRoute(
              name: 'validacaodocodigo2',
              path: 'validacaodocodigo2',
              builder: (context, params) => Validacaodocodigo2Widget(
                codigo: params.getParam('codigo', ParamType.String),
                placa: params.getParam('placa', ParamType.String),
                marca: params.getParam('marca', ParamType.String),
                modelo: params.getParam('modelo', ParamType.String),
            ...
            FFRoute(
              name: 'Alterar_dados_do_proprietarioCopy',
              path: 'DadosDoProprietario',
              asyncParams: {
                'referencia': getDoc(['veiculo'], VeiculoRecord.fromSnapshot),
              },
              builder: (context, params) =>
                  AlterarDadosDoProprietarioCopyWidget(
                referencia: params.getParam('referencia', ParamType.Document),
              ),
            )
