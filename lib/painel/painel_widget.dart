...
class _PainelWidgetState extends State<PainelWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'PAINEL'});
    setupAnimations(
      ...
      child: Scaffold(
                              ...
                              child: Column(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PAINEL_PAGE_Row_p5503lbe_ON_TAP');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PAINEL_PAGE_Row_mn9dzxci_ON_TAP');
                                      logFirebaseEvent('Row_navigate_to');

                                      context.pushNamed('Solicitar_codigo');
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PAINEL_PAGE_Row_fpgirj0l_ON_TAP');
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            ...
            highlightColor: Colors.transparent,
            onTap: () async {
              logFirebaseEvent('PAINEL_PAGE_Icon_kr09dnqe_ON_TAP');
              ...
              children: [
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('PAINEL_PAGE_Container_y58jtvgc_ON_TAP');
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('PAINEL_PAGE_Container_87xfqsrh_ON_TAP');
                      logFirebaseEvent('Container_navigate_to');
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('PAINEL_PAGE_Container_bd7p6y2b_ON_TAP');
                      logFirebaseEvent('Container_navigate_to');
