...
class _CadastrarWidgetState extends State<CadastrarWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'CADASTRAR'});
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CADASTRAR_PAGE_Button-Login_ON_TAP');
                              logFirebaseEvent('Button-Login_backend_call');
                              await EnviarMensagemCall.call(
                                nome:
                                    'Credenciado ${_model.nomeController.text}',
                              ...
                              await ContatoCall.call(
                                ...
                                nomeDoContato: _model.nomeController.text,
                                whatsappDoAplicador:
                                    '55${_model.whatsappController.text}',
                              );
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text(
                                        'Olá, ${_model.nomeController.text}'),
                                    content: Text(
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 24.0, 0.0, 55.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CADASTRAR_PAGE_ENTRAR_BTN_ON_TAP');
